...
<body>
<div class="well lead">Edit Word in ${wordsGroup.name}</div>
    ...
    <div class="row">
        <div class="form-group col-md-12">
            <div class="col-md-4 text-colour">
                <input type="submit" value="Done" id="editWordDone" class="btn btn-success btn-sm"/> or <a href="/view-group?wordsGroupId=${wordsGroup.id}&ssoId=${ssoId}">Cancel</a>
            </div>
        </div>
    </div>
